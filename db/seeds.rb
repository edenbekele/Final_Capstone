...
Image.create!(artist_id: 6, image: "Alex2.JPG")
Image.create!(artist_id: 7, image: "Daniella1.jpg")
Image.create!(artist_id: 7, image: "Daniella2.jpg")
